<%@ Page Title="" Language="C#" MasterPageFile="~/UI/MP/MpAdmin.Master" AutoEventWireup="true" CodeBehind="RolePermission.aspx.cs" Inherits="PNF.UI.RoleMgmt.RolePermission" %>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlLevel" CssClass="form-control" Required OnSelectedIndexChanged="ddlLevel_SelectedIndexChanged" AutoPostBack="True">
