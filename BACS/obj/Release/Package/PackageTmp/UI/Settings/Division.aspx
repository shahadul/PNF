<%@ Page Title="" Language="C#" MasterPageFile="~/UI/MP/MpAdmin.Master" AutoEventWireup="true" CodeBehind="Division.aspx.cs" Inherits="PNF.UI.Settings.Division" %>
        ...
        <div class="form-horizontal" role="form">
            <div class="panel-group">
                <div class="panel panel-info" style="align-items: center;">
                    <div class="panel-heading text-center" style="font-weight: bold; font-size: medium;">Division Setup</div>
                                    ...
                                    <fieldset>
                                       ...
                                       <%-- <div class="form-group col-xs-3">
                                        ...
                                        <div class="form-group">
                                            <asp:Label runat="server" AssociatedControlID="txtDivision" CssClass="col-md-2 control-label">Division</asp:Label>
                                            <div class="col-xs-4">
                                                <asp:TextBox runat="server" ID="txtDivision" CssClass="form-control" Required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <asp:HiddenField runat="server" ID="HIDDivisionID" />
            ...
            <div class="form-group col-xs-6">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDivision" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            OnSelectedIndexChanging="gvDivision_SelectedIndexChanged" AllowSorting="True" PageSize="8" AllowPaging="True" OnPageIndexChanging="gvDivision_PageIndexChanging" Width="100%" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
